...
const WhyUs = () => {
  return (
    <div className="min-h-screen flex flex-col items-center mt-20 sm:mt-24 md:mt-28 lg:mt-30 px-4 sm:px-6 md:px-8 lg:px-10">
      <div className="flex flex-col items-center gap-3 sm:gap-4">
        ...
        <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[48px] text-center font-[700] leading-tight sm:leading-snug lg:leading-normal px-2">
          Not Just Instant{" "}
